...
import type { SandboxSessionDTO, SandboxStatus } from '../../types/index.js';
...
export async function exchangeGuestTicket(
  ticket: string,
        ...
        : [
            {
              ...
              source: 'microvm-init',
              message: 'Bootstrapped Linux kernel in 24ms',
            },
            {
              timestamp: new Date().toISOString(),
              source: 'docker-layer',
              message: 'Mounted container image crux-app:v2.4',
            },
          ],
  };
}
