...
import { redisClient, redisPubClient, redisSubClient, connectRedis } from './config/redis.js';
...
export async function bootstrap() {
  logger.info({ env: config.NODE_ENV, port: config.PORT }, 'Initializing Crux Backend Service (Hono)...');
