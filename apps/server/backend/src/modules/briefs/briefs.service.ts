...
import { PRBriefDTO } from '../../types/index.js';
...
export async function getPRBrief(repoId: string, prId: string): Promise<PRBriefDTO> {
  ...
  if (res.rowCount === 0) {
    ...
    return {
      ...
      criticalPaths: [
        { path: 'src/concurrency/redlock.ts', reason: 'Distributed mutex logic', riskLevel: 'high' },
      ],
      suggestedChecklist: [
  ...
  return {
    ...
    coverageDeltaPercent: parseFloat(b.coverage_delta_percent) || 0,
    breakingChangesCount: b.breaking_changes_count,
    summary: b.summary,
    criticalPaths: typeof b.critical_paths === 'string' ? JSON.parse(b.critical_paths) : b.critical_paths,
    suggestedChecklist: typeof b.suggested_checklist === 'string' ? JSON.parse(b.suggested_checklist) : b.suggested_checklist,
